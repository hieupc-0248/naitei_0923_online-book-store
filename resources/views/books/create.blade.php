                        ...
                        <div class="grid grid-cols-2 gap-8">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="stock" type="number" class="form-input rounded-lg w-full @error('stock') border-red-500 @enderror" name="stock" value="{{ old('stock') }}" required autocomplete="stock">
                                    @error('stock')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
