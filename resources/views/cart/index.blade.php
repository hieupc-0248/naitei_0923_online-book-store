                        ...
                        @foreach ($cartItems as $cartItem)
                            <tr class="cart-item-wrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-xl text-gray-500 dark:text-gray-900">
                                    <div class="flex items-center justify-center quantity-group mt-4">
                                        ...
                                        <span id="quantity" data-id="{{ $cartItem->book_id }}" data-book-stock="{{ $cartItem->book->stock }}" data-book-price="{{ $cartItem->book->price }}" class="px-4">{{ $cartItem->quantity }}</span>
                                    ...
                                    <div class="flex justify-center error-info" id="error-info-{{ $cartItem->book_id }}">
                                        <p class="text-base text-red-500">
                                        {{ __("Have") }} {{ $cartItem->book->stock }} {{ __("books in stock") }}
                                        </p>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-xl text-gray-500 dark:text-gray-900">
